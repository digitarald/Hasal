...
class TestSikuli(PerfBaseTest):
    ...
    def test_chrome_facebook_load_homepage(self):
        args = [self.env.img_sample_dp, self.env.img_output_sample_1_fn, '0', '0', str(self.env.DEFAULT_VIDEO_RECORDING_WIDTH), str(self.env.DEFAULT_VIDEO_RECORDING_HEIGHT)]
